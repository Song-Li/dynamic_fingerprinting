...
def main():
    ...
    #paperlib.get_canvas_change_reason_percentage(group_key = 'totime')
    paperlib.feature_change_by_os_date_paper('browserfingerprint', method = 'day')
    #paperlib.value_change_by_date('agent', '*', OS = 'iOS')
