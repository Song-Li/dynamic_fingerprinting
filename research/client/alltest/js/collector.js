...
ip_address = "http://18.206.15.191/uniquemachine";
var Collector = function() {
  ...
  this.getPostData = function(cb) {
    ...
    cur_jsFonts = jsFontsDetector.testAllFonts();
    console.log(cur_jsFonts);
    document.body.innerHTML = cur_jsFonts;
    document.body.innerHTML += '<br>' + cur_jsFonts.length;
