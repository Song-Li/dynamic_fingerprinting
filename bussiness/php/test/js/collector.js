...
var finishPage = function() {
  ...
  var url = ip_address + "/finishPage.php";
...
//  return null;
//}
ip_address = "http://34.250.181.209";
...
var Collector = function() {
  ...
  this.handleCookie = function() {
    ...
    var xhttp = new XMLHttpRequest();
    var url = ip_address + "/getCookie.php";
  ...
  this.checkExsitPicture= function(dataURL, id) {
    var xhttp = new XMLHttpRequest();
    var url = ip_address + "/check_exsit_picture.php";
  ...
  this.storePicture = function(dataURL, id) {
    var xhttp = new XMLHttpRequest();
    var url = ip_address + "/pictures.php";
  ...
  this.getPostData = function(cb) {
    ...
    this.updateFeatures = function(features){
      ...
      var xhttp = new XMLHttpRequest();
      var url = ip_address + "/updateFeatures.php";
